...
/*!************************************!*\
  !*** ./src/app/_services/index.ts ***!
  \************************************/
/*! exports provided: AlertService, UserService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.getAll = function () {
        return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].apiUrl + "/all_users");
    };
    ...
    UserService.prototype.getAuthenticatedUser = function () {
        return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].apiUrl + "/auth");
    };
...
/* harmony import */ var _users_list_users_list_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./users-list/users-list.component */ "./src/app/users-list/users-list.component.ts");
...
var ProfileComponent = /** @class */ (function () {
    function ProfileComponent(_Activatedroute, _userService) {
    ...
    ProfileComponent.prototype.ngOnInit = function () {
        ...
        this._userService.getById(this.currentUserId).subscribe((function (data) {
            _this.user = data;
            console.log(data);
        }));
    };
    ProfileComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_1__["ActivatedRoute"], _services__WEBPACK_IMPORTED_MODULE_2__["UserService"]])
    ], ProfileComponent);
...
var UsersListComponent = /** @class */ (function () {
    ...
    UsersListComponent.prototype.ngOnInit = function () {
        var _this = this;
        this._userService.getAuthenticatedUser().subscribe((function (data) {
            _this.onlineUserId = data.id;
        }));
        this._userService.getAll().subscribe((function (data) {
            _this.users = data;
            for (var _i = 0, _a = _this.users; _i < _a.length; _i++) {
                var user = _a[_i];
                if (user.id === _this.onlineUserId) {
                    user.status = 'online';
                }
            }
        }));
...
module.exports = __webpack_require__(/*! /home/islam/maxab-training/first-angular-project/src/main.ts */"./src/main.ts");
